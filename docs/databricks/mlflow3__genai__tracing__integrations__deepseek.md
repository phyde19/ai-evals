<!-- source: https://docs.databricks.com/aws/en/mlflow3/genai/tracing/integrations/deepseek -->
...
[MLflow Tracing](</aws/en/mlflow3/genai/tracing/>) provides automatic tracing capability for Deepseek models through the OpenAI SDK integration. Since DeepSeek uses an OpenAI-compatible API format, you can use [`mlflow.openai.autolog()`](<https://mlflow.org/docs/latest/api_reference/python_api/mlflow.openai.html#mlflow.openai.autolog>) to trace interactions with DeepSeek models.
...
**API Keys** : Ensure your DeepSeek API key is configured. For production use, use [Mosaic AI Gateway or Databricks secrets](</aws/en/mlflow3/genai/tracing/integrations/#secure-api-key-management>) instead of hardcoded values:
...
Chat Completion| Function Calling| Streaming| Async| â | â | â (*1)| â (*2)  
---|---|---|---  
...
## Streaming and Async Supportâ

MLflow supports tracing for streaming and async DeepSeek APIs. Visit the [OpenAI Tracing documentation](</aws/en/mlflow3/genai/tracing/integrations/openai>) for example code snippets for tracing streaming and async calls through OpenAI SDK.

## Advanced Example: Function Calling Agentâ
